    ...
    <div className="logo">
      ...
      <div className='form-login'>
        <div className="content-form-login">
          <div className="sitename-title">{t('pages:resetPassword.title')}</div>
          <div className="sitename">{t('pages:resetPassword.content_kddi')}</div>
        </div>
      <Form
        onFinish={onFinish}
        form={form}
      ...
      >
        <Col md={24} sm={24} xs={24}>
          <div style={{ marginBottom: 5, fontWeight: 600 }}>{t('pages:resetPassword.newPassword')}</div>
          <Form.Item
            name="newPassword"
            rules={[
        ...
        <Col md={24} sm={24} xs={24}>
        <div style={{ marginBottom: 5, fontWeight: 600 }}>{t('pages:resetPassword.reNewPassword')}</div>
          <Form.Item
            name="reNewPassword"
            rules={[
