  ...
  const activeTenants = async ({code}:{code: string}) => {
    ...
    setContentModal([
      <div>
        ...
        <br/>
        <Card title="Tenant">
          <p>{t("pages:tenants.table.name")}: {tenant.name}</p>
          <p>{t("pages:tenants.table.email")}: {tenant.email}</p>
          <p>{t("pages:tenants.table.phone")}: {tenant.phone}</p>
          <p>{t("pages:tenants.table.address")}: {tenant.address}</p>
        </Card>
        <br/>
        <Card title="Account Admin">
        <p>{t("pages:users.table.email")}: {tenant.others.email}</p>
        <p>{t("pages:users.form.password")}: {tenant.others.password}</p>
        </Card>
      </div>
    ])
    setLoading(false)
