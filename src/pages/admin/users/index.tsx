...
const Index = () => {
  ...
  const columns = [
    ...
    {
      title: t("pages:users.table.twofa"),
      dataIndex: "twofa",
      key: "users.twofa",
      sorter: true,
      filterable: true,
      render: (text: string, record: any) => {
        return (
          <Tag color={record.twofa ? "green" : "red"}>
            {record.twofa ? "ON" : "OFF"}
          </Tag>
        );
      }
    ...
    {
      title: t("pages:users.table.Active_status"),
      ...
      render: (text: string, record: any) => {
        return (
          <Tag color={record.Active_status ? "green" : "red"}>
            {record.Active_status ? "ON" : "OFF"}
          </Tag>
        );
      }
    },
    {
      title: t("pages:users.table.last_activicy_date"),
      dataIndex: "last_activicy_date",
      key: "users.last_activicy_date",
      sorter: true,
      filterable: true,
      render: (text: string, record: any) =>
        ...
        <Space size="middle">
          {
            ...
            //   type="primary"
            //   className="btn-top"
            //   onClick={() => redirect("frontend.admin.users.editTmp", { id: record.code })}
            // >
            //   <EditOutlined />
            // </a>
            ""
